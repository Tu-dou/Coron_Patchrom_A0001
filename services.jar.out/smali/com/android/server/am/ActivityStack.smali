...
.method private completePauseLocked()V
    ...
    sget-boolean v9, Lcom/android/server/am/ActivityStack;->DEBUG_PAUSE:Z
    ...
    const-string v11, "completePauseLocked, pause actName:"
    ...
    .line 923
    const-string v9, "com.android.incallui/.OppoInCallActivity"
    ...
    const-string v10, "completePauseLocked, finish OppoInCallActivity not wating idle"
    ...
    invoke-virtual {p0, v5, v4, v9}, Lcom/android/server/am/ActivityStack;->finishCurrentActivityLocked(Lcom/android/server/am/ActivityRecord;IZ)Lcom/android/server/am/ActivityRecord;
    ...
    iget-wide v9, v5, Lcom/android/server/am/ActivityRecord;->cpuTimeAtResume:J
    ...
    iget-object v10, v9, Lcom/android/server/am/ActivityManagerService;->mProcessCpuThread:Ljava/lang/Thread;
    ...
    iget-object v11, v5, Lcom/android/server/am/ActivityRecord;->app:Lcom/android/server/am/ProcessRecord;
    ...
    iget-wide v13, v5, Lcom/android/server/am/ActivityRecord;->cpuTimeAtResume:J
    ...
    invoke-virtual {v1, v9, v10}, Lcom/android/internal/os/BatteryStatsImpl;->getProcessStatsLocked(ILjava/lang/String;)Lcom/android/internal/os/BatteryStatsImpl$Uid$Proc;
    ...
    iput-wide v9, v5, Lcom/android/server/am/ActivityRecord;->cpuTimeAtResume:J
    ...
    .line 934
    :cond_9
    iget-boolean v9, v5, Lcom/android/server/am/ActivityRecord;->waitingVisible:Z
    ...
    iput-boolean v9, v5, Lcom/android/server/am/ActivityRecord;->waitingVisible:Z
    ...
    .line 937
    sget-boolean v9, Lcom/android/server/am/ActivityStack;->DEBUG_SWITCH:Z
    ...
    const-string v11, "pause-config"

    invoke-virtual {p0, v5, v9, v10, v11}, Lcom/android/server/am/ActivityStack;->destroyActivityLocked(Lcom/android/server/am/ActivityRecord;ZZLjava/lang/String;)Z
...
.method goToSleep()V
    ...
    invoke-virtual {p0}, Lcom/android/server/am/ActivityStack;->isLockScreenOnTop()Z

    move-result v6

    invoke-virtual {p0, v4, v5, v6}, Lcom/android/server/am/ActivityStack;->ensureActivitiesVisibleLocked(Lcom/android/server/am/ActivityRecord;IZ)Z
...
.method final moveTaskToBackLocked(ILcom/android/server/am/ActivityRecord;)Z
    ...
    invoke-virtual {v7, v10}, Lcom/android/server/am/TaskRecord;->topRunningActivityLocked(Lcom/android/server/am/ActivityRecord;)Lcom/android/server/am/ActivityRecord;
    ...
    const-string v12, "moveTaskToBack this task is null: taskNdx = "
    ...
    .line 3242
    :cond_4
    iget-boolean v10, v7, Lcom/android/server/am/TaskRecord;->mOnTopOfHome:Z
    ...
    const-string v12, "moveTaskToBack the top is exist: taskNdx = "
    ...
    const-string v12, "moveTaskToBack : setTop = "
    ...
    iget-object v7, v10, Lcom/android/server/am/ActivityRecord;->task:Lcom/android/server/am/TaskRecord;
    ...
    iput-boolean v10, v7, Lcom/android/server/am/TaskRecord;->mOnTopOfHome:Z
