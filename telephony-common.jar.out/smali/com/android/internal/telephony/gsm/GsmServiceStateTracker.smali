...
.method private pollStateDone()V
    ...
    sget-wide v44, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->lastTime:J
    ...
    sput-wide v44, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->lastTime:J

    .line 1356
    const-string v44, "GsmSST"

    const-string v45, "oppo: send OPPOEVENT_CHECK_NO_SERVICE event"
    ...
    const-string v45, "Current VoiceRadioTechnology = "
    ...
    invoke-static/range {v44 .. v44}, Landroid/telephony/ServiceState;->isGsm(I)Z
    ...
    invoke-virtual/range {v44 .. v44}, Landroid/telephony/gsm/GsmCellLocation;->getCid()I
    ...
    .line 1393
    sget-object v44, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mGWCellLoc:Landroid/telephony/gsm/GsmCellLocation;
    ...
    invoke-virtual/range {v46 .. v46}, Landroid/telephony/gsm/GsmCellLocation;->getCid()I

    move-result v46

    invoke-virtual/range {v44 .. v46}, Landroid/telephony/gsm/GsmCellLocation;->setLacAndCid(II)V
    ...
    invoke-virtual/range {v44 .. v45}, Landroid/telephony/gsm/GsmCellLocation;->setPsc(I)V
    ...
    sput-boolean v44, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mIsFarAway:Z
    ...
    .line 1417
    new-instance v36, Landroid/telephony/gsm/GsmCellLocation;

    invoke-direct/range {v36 .. v36}, Landroid/telephony/gsm/GsmCellLocation;-><init>()V

    .line 1418
    .local v36, tempcl:Landroid/telephony/gsm/GsmCellLocation;
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v44 .. v44}, Landroid/telephony/gsm/GsmCellLocation;->getPsc()I
    ...
    const-string v46, "Reselection to a new LTE cell, add "
    ...
    .line 1426
    .end local v36           #tempcl:Landroid/telephony/gsm/GsmCellLocation;
    :cond_18
    :goto_e
    monitor-exit v45
    :try_end_1
    ...
    .line 1423
    const-string v44, "You have leave far away from latest GW cell, ignore"
...
.method private setTimeZone()Z
    ...
    const-string v6, "setTimeZone: no nitz but one TZ for iso-cc="
    ...
    const-string v6, " testOneUniqueOffsetPath="
    ...
    const-string v6, "setTimeZone: there are "
    ...
    const-string v6, " unique offsets for iso-cc=\'"
...
.method protected handlePollStateResult(ILandroid/os/AsyncResult;)V
    ...
    invoke-virtual {v0, v12}, Landroid/telephony/ServiceState;->setRilVoiceRadioTechnology(I)V
    ...
    const-string v21, "handlePollState : using voice radio tech "
    ...
    const-string v21, "handlePollState :  lac is invalid : lac="
...
.method protected updateSpnDisplay()V
    ...
    invoke-virtual {v2, v14}, Lcom/android/internal/telephony/uicc/IccRecords;->getDisplayRule(Ljava/lang/String;)I
    ...
    invoke-static {v14, v6}, Lcom/android/internal/telephony/gsm/OppoGsmServiceStateTracker;->oppoGetAustraliaPlmn(Landroid/telephony/ServiceState;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 853
    .local v10, simNumeric:Ljava/lang/String;
    new-instance v14, Ljava/lang/StringBuilder;
    ...
    const-string v15, "spnDisplayCondition = "
    ...
    const-string v15, "mSS.getRoaming():"
    ...
    const-string v15, "oppo.cmcc.optr"
    ...
    .line 898
    const-string v14, "GsmServiceStateTracker Roaming entry----------------"
    ...
    invoke-static {v14, v15}, Lcom/android/internal/telephony/gsm/OppoGsmServiceStateTracker;->oppoGetPlmnOverride(Ljava/lang/String;Landroid/telephony/ServiceState;)Ljava/lang/String;
    ...
    .line 913
    :cond_c
    const-string v14, "[Oppo] Ignore null plmn"
    ...
    .line 939
    .end local v10           #simNumeric:Ljava/lang/String;
    :cond_d
    :goto_9
    move-object/from16 v0, p0
    ...
    .restart local v10       #simNumeric:Ljava/lang/String;
    :cond_18
    move-object/from16 v0, p0
    ...
    .line 874
    :cond_1a
    const-string v14, "do not satisfy the requirement of Mexico"
    ...
    .line 919
    :cond_1c
    const-string v14, "[Oppo] can\'t show spn"
    ...
    invoke-virtual {v14, v3, v15}, Landroid/content/Context;->sendStickyBroadcastAsUser(Landroid/content/Intent;Landroid/os/UserHandle;)V
